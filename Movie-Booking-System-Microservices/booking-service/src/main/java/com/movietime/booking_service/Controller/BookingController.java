...
public class BookingController {
    ...
    public ResponseEntity<BookingResponse> createBooking(@RequestHeader("X-User-Email") String userEmail,@RequestBody CreateBookingRequest req) {
        ...
        log.info("BOOKING_STARTED | bookingId={} | userId={} | sessionId={}", booking.getId(), userEmail, req.getSessionId());
    ...
    @GetMapping("/show/{sessionId}/seats/status")
    public SeatStatusResponse getSeatStatus(@PathVariable Long sessionId) {
        return bookingService.getSeatStatus(sessionId);
    }
    @GetMapping("/my")
    ...
    public ResponseEntity<BookingResponse> cancelBooking(
        ...
        BookingResponse cancelledBooking = bookingService.cancelBooking(bookingId, userEmail);
